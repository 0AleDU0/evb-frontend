...
@Component({
  ...
  imports: [],
  templateUrl: './surprised.html',
  styleUrl: './surprised.scss',
})
export class Surprised {
  ...
  protected mouthRx = computed(() => 20 + this.mouthOpen() * 8);
  protected mouthRy = computed(() => 24 + this.mouthOpen() * 22);
